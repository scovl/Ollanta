// Package metrics provides the built-in metric registry for Ollanta.
...
// All returns a copy of all built-in MetricDefs.
func All() []MetricDef {
...
// Find returns a copy of the MetricDef with the given key, or nil if not found.
func Find(key string) *MetricDef {
