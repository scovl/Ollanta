...
// GoogleProvider implements port.IOAuthProvider for Google.
...
// compile-time check
var _ port.IOAuthProvider = (*GoogleProvider)(nil)
...
func (p *GoogleProvider) Exchange(ctx context.Context, code string) (*model.OAuthUser, error) {
	body := url.Values{
		"client_id":     {p.ClientID},
